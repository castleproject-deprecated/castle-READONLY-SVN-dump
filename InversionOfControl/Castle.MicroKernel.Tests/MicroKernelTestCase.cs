...
namespace Castle.MicroKernel.Tests
{
	...
	public class MicroKernelTestCase
	{
		...
		[Test,ExpectedException(typeof(ComponentRegistrationException),
			ExpectedMessage = "Type Castle.MicroKernel.Tests.ClassComponents.BaseCommonComponent is abstract.\r\n As such, it is not possible to instantiate it as implementation of Castle.MicroKernel.Tests.ClassComponents.ICommon service")]
		...
		[Test,ExpectedException(typeof(ComponentRegistrationException),
			ExpectedMessage = "Type Castle.MicroKernel.Tests.ClassComponents.BaseCommonComponent is abstract.\r\n As such, it is not possible to instantiate it as implementation of Castle.MicroKernel.Tests.ClassComponents.BaseCommonComponent service")]
